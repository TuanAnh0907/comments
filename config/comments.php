...
return [
     ...
     */
    'model' => \TuanAnh0907\Comments\Comment::class,
     ...
     */
    'permissions' => [
        'create-comment' => 'TuanAnh0907\Comments\CommentPolicy@create',
        'delete-comment' => 'TuanAnh0907\Comments\CommentPolicy@delete',
        'edit-comment' => 'TuanAnh0907\Comments\CommentPolicy@update',
        'reply-to-comment' => 'TuanAnh0907\Comments\CommentPolicy@reply',

        'like-comment' => 'TuanAnh0907\Comments\LikePolicy@like',
        'dislike-comment' => 'TuanAnh0907\Comments\LikePolicy@destroy',
    ],
     ...
     */
    'controller' => '\TuanAnh0907\Comments\WebCommentController',
