...
@if ($comments->count() < 1)
    <div class="my-2">@lang('comments::comments.there_are_no_comments')</div>
@endif
...
@else
    <div class="card my-2">
        <div class="card-body">
            <h5 class="">@lang('comments::comments.authentication_required')</h5>
            <p class="">@lang('comments::comments.you_must_login_to_post_a_comment')</p>
            <a href="{{ route('web.login') }}" class="text-[#45abff]">@lang('comments::comments.log_in')</a>
        </div>
    </div>
@endauth
